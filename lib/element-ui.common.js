...
exports.default = {
  ...
  methods: {
    ...
    mountPicker: function mountPicker() {
      ...
      this.picker.$on('range-change', function (val) {
        _this3.$emit('range-change', val);
      });
    },
